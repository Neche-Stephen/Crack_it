...
import styles from './MonthlyQuestModal.module.css'

import left_arrow from './asset/left_arrow.png'

export default function MonthlyQuestModal(props) {
  console.log(props)
  return (
    <Modal
    {...props}
    ...
    <Modal.Body className={`${styles.today_challenge_body}`}>
      <div className={`${styles.today_challenge_row} row mb-3 align-items-center` }>
        ...
        <div className='col-auto mx-auto'>
          <p className={`${styles.today_challenge_text}`} >Month's Challenge</p>
        </div>
